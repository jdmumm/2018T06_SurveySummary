#Format tables for 2017 PWS Survey SUmmary, mstly from 2017T04 script, in turn mstly 
#from 931_popEstAndCPUE_161101.R used for 2016 report
...
options (scipen = 10)
dat <- read.csv('./data/qP_simp_181031.csv') # N-H
